...
df.to_csv(f'final_manual_data_{todaysdate}.csv', index=False)
df.to_csv(f'final_manual_data_{todaysdate}_BACKUP.csv', index=False)
...
df1.to_csv(f'final_manual_data_reattempt_1_{todaysdate}.csv', index=False)
